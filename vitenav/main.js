    ...
    for (const result of results) {
      ...
      if (state == "tracked") {
        ...
        if (imageIndex == 0) {
          ...
          console.log(
            "Hiro Image target has been found",
            hiroMarkerMesh.position
          );
        ...
        if (imageIndex == 1) {
          ...
          console.log(
            "EarthNFT Image target has been found",
            earthNFTMesh.position
          );
...
function setupGeometry() {
  // create occluder material, This is for invisible walls
